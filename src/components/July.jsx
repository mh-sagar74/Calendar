...
import styles from "./july.module.css";
...
export default function July() {
  ...
  useEffect(() => {
    ...
    const firstDate = new Date(year, 6, 1);
    const days = [];

    while (firstDate.getMonth() === 6) {
      days.push(new Date(firstDate));
      firstDate.setDate(firstDate.getDate() + 1);
    }

    setDaysInMonth(days);
    setStartDay(new Date(year, 6, 1).getDay());
  }, [currDate]);

  return (
    <div className={styles.july}>
